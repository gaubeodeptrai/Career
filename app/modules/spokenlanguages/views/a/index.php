...
$this->title = Yii::t('easyii/spokenlanguages', 'Spokenlanguages');
...
<?php if($data->count > 0) : ?>
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <?php endif; ?>
                <th>Country name</th>
                <th width="100" style="text-align:center"><?= Yii::t('easyii', 'Status') ?></th>
                <th width="120"></th>
            </tr>
        </thead>
        <tbody>
    <?php foreach($data->models as $item) : ?>
            <tr data-id="<?= $item->primaryKey ?>">
                ...
                <?php endif; ?>
                <td><a href="<?= Url::to(['/admin/'.$module.'/a/edit/', 'id' => $item->primaryKey]) ?>"><?= $item->language_name ?></a></td>
                <td class="status">
                    <?= Html::checkbox('', $item->status == Spokenlanguages::STATUS_ON, [
                        'class' => 'switch',
